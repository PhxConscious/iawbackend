...
router.post('/new/:company_id', function (req, res, next) {
    knex('company_table')
        .insert({
            ...
            primary_contact_full_name: req.body. primary_contact_full_name,
            primary_contact_phone_number: req.body. primary_contact_phone_number,
            ...
            instagram_bio: req.body.instagram_bio,
            insta_goal1: req.body.insta_goal1,
            insta_goal2: req.body.insta_goal2,
            insta_goal3: req.body.insta_goal3,
            cloudbased_storage_locale: req.body.cloudbased_storage_locale,
        ...
        .returning("*")
        .then(data => {
          knex("company_table").select("*").where("company_id", req.params.company_id).then(company => {
            res.send(company)
          })
        })
});
...
router.put('/new/:company_id', function (req, res, next) {
    ...
    knex('company_table').select().where("company_id", req.params.company_id)
        .update({
            company_id: req.params.company_id,
            company_name: req.body.company_name,
            company_email: req.body.company_email,
